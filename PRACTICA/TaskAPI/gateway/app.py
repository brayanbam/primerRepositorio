...
def consultar_servicio(
    ...
    print(
        f"\n[GATEWAY] Consultando servicio: {nombre}",
        flush=True
    )
    ...
    try:
        ...
        print(
            f"{nombre} respondió correctamente "
            f"en {tiempo_total} segundos",
            flush=True
        )
        ...
        return jsonify({
            "error":
            f"Servicio {nombre} no disponible"
        }), 503
...
def usuarios():
    ...
    print(
        f"Solicitud recibida en /usuarios "
        f"[{request.method}]",
        flush=True
    )
...
def tareas():
    ...
    print(
        f"Solicitud recibida en /tareas "
        f"[{request.method}]",
        flush=True
    )
...
@app.route('/analisis/dashboard')
def analisis_dashboard():
    ...
    return consultar_servicio(
        "analisis",
        "GET",
        "http://analisis:5000/dashboard"
    )


@app.route('/analisis/productividad')
def analisis_productividad():
    ...
    return consultar_servicio(
        "analisis",
        "GET",
        "http://analisis:5000/productividad/usuarios"
    )


@app.route('/analisis/metricas')
def analisis_metricas():
    ...
    return consultar_servicio(
        "analisis",
        "GET",
        "http://analisis:5000/metricas/diarias"
    )
...
def analisis_tiempo():
    ...
    return consultar_servicio(
        "analisis",
        "GET",
        "http://analisis:5000/tiempo/promedio"
    )
